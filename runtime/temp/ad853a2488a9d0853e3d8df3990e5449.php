<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpStudy\PHPTutorial\WWW\jifei\public/../application/admin\view\teacher\edit.html";i:1540260717;s:85:"D:\phpStudy\PHPTutorial\WWW\jifei\public/../application/admin\view\template\base.html";i:1540375638;s:96:"D:\phpStudy\PHPTutorial\WWW\jifei\public/../application/admin\view\template\javascript_vars.html";i:1488957233;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="技师名称" name="name" value="<?php echo isset($vo['name']) ? $vo['name'] :  ''; ?>" datatype="*" nullmsg="技师名称不能为空" >
            </div>
