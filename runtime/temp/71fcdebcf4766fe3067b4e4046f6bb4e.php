...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        <input type="hidden" class="input-text" name="id" value="<?php echo $user['id']; ?>" >
        <input type="hidden" class="input-text" name="uid" value="<?php echo $user['uid']; ?>" >
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3">总价格：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="总价格" name="sprice" value="<?php echo $user['sprice']; ?>" >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3">股东提成：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text"  readonly="readonly" value="<?php echo $user['sprice']; ?>">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <table border="1" id ="table">
                    <?php if(is_array($user['goods']) || $user['goods'] instanceof \think\Collection || $user['goods'] instanceof \think\Paginator): $i = 0; $__LIST__ = $user['goods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td style='display: none;text-align: center'><input style='border: none' type='text' name='goodsId[]' value='<?php echo $vo->goodsId; ?>'></td>
                        <td style='display: none;text-align: center'><input style='border: none' type='text' name='goodsExtra[]' value='<?php echo $vo->goodsExtra; ?>'></td>
                        <td><input style='border: none;text-align: center' type='text' name='goodsSname[]' value='<?php echo $vo->goodsSname; ?>'></td>
                        <td><input style='border: none;text-align: center' type='text' name='goodsPrice[]' value='<?php echo $vo->goodsPrice; ?>'>元</td>
                        <td><input style='border: none;text-align: center' type='text' name='goodsNum[]' value='<?php echo $vo->goodsNum; ?>'>件</td>
