    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="商品名称" name="name" value="<?php echo isset($vo['name']) ? $vo['name'] :  ''; ?>" datatype="*" nullmsg="商品名称不能为空" >
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="商品价格（元）" name="price" value="<?php echo isset($vo['price']) ? $vo['price'] :  ''; ?>" datatype="*" nullmsg="商品价格不能为空"  >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="股东分成（%）" name="extra" value="<?php echo isset($vo['extra']) ? $vo['extra'] :  ''; ?>" datatype="*" nullmsg="股东分成"  >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <select name="type" id="select" class="select-box"  onchange="sort(this)" datatype="*" nullmsg="请选择分类">
                    <option value="<?php echo $vo['type']; ?>" ><?php echo $vo['tname']; ?></option>
                </select>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <select name="stype" id="selectson" class="select-box" datatype="*" nullmsg="请选择二级分类">
                    <option value="<?php echo $vo['stype']; ?>" ><?php echo $vo['stname']; ?></option>
                </select>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
