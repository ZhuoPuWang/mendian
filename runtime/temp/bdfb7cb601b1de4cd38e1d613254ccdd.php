...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo url('add'); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" name="consume" datatype="n" nullmsg="请填写金额"  >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" name="discount" datatype="n" nullmsg="请填写金额"  >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
