<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"D:\phpStudy\PHPTutorial\WWW\mendian\public/../application/admin\view\goodstype\edit.html";i:1541143042;s:87:"D:\phpStudy\PHPTutorial\WWW\mendian\public/../application/admin\view\template\base.html";i:1540375638;s:98:"D:\phpStudy\PHPTutorial\WWW\mendian\public/../application/admin\view\template\javascript_vars.html";i:1488957233;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="分类名称" name="name" value="<?php echo isset($vo['name']) ? $vo['name'] :  ''; ?>" datatype="*" nullmsg="请填写分类名称" >
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <select name="son_id" id="" >
                    ...
                    <option value="<?php echo $vol['id']; ?>" <?php echo !empty($vol['id']) && $vol['id']==$vo['son_id']?'selected':''; ?>><?php echo $vo['name']; ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
                <!--<input type="text" class="input-text" placeholder="所属上级" name="son_id" value="<?php echo isset($vo['son_id']) ? $vo['son_id'] :  ''; ?>" >-->
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
